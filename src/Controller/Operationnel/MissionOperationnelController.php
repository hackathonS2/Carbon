...
#[Route('/operationnel/mission')]
class MissionOperationnelController extends AbstractController
{
    #[Route('/', name: 'operationnel_mission_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'operationnel_mission_new', methods: ['GET', 'POST'])]
    public function new(Request $request, MissionRepository $missionRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('operationnel_mission_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'operationnel_mission_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'operationnel_mission_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'operationnel_mission_delete', methods: ['POST'])]
