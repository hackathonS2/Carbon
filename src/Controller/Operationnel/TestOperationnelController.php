...
#[Route('/operationnel/test')]
class TestOperationnelController extends AbstractController
{
    #[Route('/', name: 'app_operationnel_test_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_operationnel_test_new', methods: ['GET', 'POST'])]
    public function new(Request $request, TestRepository $testRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_operationnel_test_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/new/{id}', name: 'app_operationnel_test_new_by_id_techno', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_operationnel_test_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_operationnel_test_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_operationnel_test_delete', methods: ['POST'])]
    ...
    #[Route('/techno/{id}', name: 'app_operationnel_test_show_techno', methods: ['GET'])]
