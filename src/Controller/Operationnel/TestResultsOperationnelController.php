...
#[Route('/operationnel/test/results')]
class TestResultsOperationnelController extends AbstractController
{
    #[Route('/', name: 'app_operationnel_test_results_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_operationnel_test_results_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_operationnel_test_results_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_operationnel_test_results_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_operationnel_test_results_delete', methods: ['POST'])]
