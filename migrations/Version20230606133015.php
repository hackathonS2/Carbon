 ...
 */
final class Version20230606133015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test (id INT NOT NULL, id_techno_id INT NOT NULL, nom VARCHAR(255) NOT NULL, difficulte INT NOT NULL, PRIMARY KEY(id))');
